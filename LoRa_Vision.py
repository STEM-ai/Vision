...
def preprocess_train(example_batch):
    ...
    example_batch["pixel_values"] = [train_transforms(Image.open(io.BytesIO(image)).convert("RGB")) for image in example_batch["image"]]
    example_batch["labels"] = [text2id[text] for text in example_batch["text"]]  # Convert text labels to IDs
